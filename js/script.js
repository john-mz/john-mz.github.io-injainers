...
const config = {
    serverInfo: {
        ...
        serverName: "Injainers", /*Server name*/
        serverIp: "s7j34f7.proxy.prismclients.com", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "959864392416104448" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
